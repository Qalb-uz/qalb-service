...
public enum Costs {
    BASIC("150000 ","3","зарекомендовали себя наилучшим образом" ),
    MEDIUM("250000","5", "Провели более 200 Сессий, и зарекомендовали себя наилучшим образом"),
    PRO("450000","7", "Супервизоры и другое");
